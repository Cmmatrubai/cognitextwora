        ...
        <div style={modalS.upPlans}>
          <button
            ...
            style={{
              ...
              boxShadow:
                selected === "plus"
                  ? "0 16px 40px rgba(216,100,31,0.16)"
                  : "none",
              cursor: "pointer",
              fontFamily: "inherit",
              textAlign: "left",
          ...
          >
            <div style={modalS.upPlanHead}>
              ...
              <span
                style={{ ...modalS.popularSmall, background: "var(--ember-400)" }}
              >
                Most popular
              </span>
            </div>
          ...
          <button
            ...
            style={{
              ...
              boxShadow:
                selected === "pro"
                  ? "0 16px 40px rgba(16,37,29,0.18)"
                  : "none",
              cursor: "pointer",
              fontFamily: "inherit",
              textAlign: "left",
...
const modalS: Record<string, React.CSSProperties> = {
  ...
  upPlans: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 22 },
  upPlan: {
  ...
  upPriceRow: { display: "flex", alignItems: "flex-start", gap: 2, marginBottom: 14 },
